...
var file_send_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x73, 0x65, 0x6e, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72,
	...
	0x4a, 0x0a, 0x0f, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65,
	0x6e, 0x74, 0x12, 0x37, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x73, 0x12, 0x13, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x48, 0x65, 0x6c, 0x6c,
	0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x04, 0x5a, 0x02, 0x2e,
...
var file_send_proto_depIdxs = []int32{
	0, // 0: proto.OrderManagement.ProcessOrders:input_type -> proto.HelloRequest
	1, // 1: proto.OrderManagement.ProcessOrders:output_type -> proto.HelloReply
...
type GreeterClient interface {
	...
	SayGb(ctx context.Context, in *HelloReply, opts ...grpc.CallOption) (*HelloRequest, error)
}
...
func (c Client)SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
func (c Client)SayGb(ctx context.Context, in *HelloReply, opts ...grpc.CallOption) (*HelloRequest, error) {
...
// ---- server -----
func RegisterGreetServer(s *grpc.Server, srv GreeterServer) {
...
var _serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SayGb",
			Handler:    _Server_SubSayGb_Handler,
		},
	},
...
func _Server_SubSayGb_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error)  {
	in := new(HelloReply)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).SayGb(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Greeter/SayGb",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SayGb(ctx, req.(*HelloReply))
	}
	return interceptor(ctx, in, info, handler)
}
...
type GreeterServer interface {
	...
	SayGb(context.Context, *HelloReply) (*HelloRequest, error)
}
